...
class EmailServices:
    """Class to manage all email variables and send the emails via smtp"""
    ...
    def __init__(self):
        ...
        # SMTP Variables
        self.smpt = True
        self.sender = 'supportemail@domain.com'
        ...
        # AD Stuff
        self.q = pyad.adquery.ADQuery()
        self.domain_name = "domain"
        self.top_level_domain = "local"

    def send_email(self, display_name):
        """Poorly named function to grab the needed information and initiate sending the emails"""
        ...
        try:
            ...
            print(f"File for {self.display_name} already sent or doesn't exist. Skipping...")
            return False
    ...
    def pull_first_name(self):
        """Function to pull the first name of the newhire"""
    ...
    def pull_manager_name(self):
        """Function to pull the managers name from information pulled from AD"""
    ...
    def send_employee_smtp(self):
        """Function to send the employee's email via SMTP"""
        ...
        msg_text = MIMEText(f"<p>Hello {self.first_name},</p>"
                            ...
                            f"<p></p>"
                            f"<p>Thanks,</p>"
                            f"<p style='font-size:8.0pt'>Did you know that we have a "
                            f"Frequently Asked Questions and Knowledge Base website? "
                            f"You can also submit tickets there!</p>"
                            f"<p style='font-size:8.0pt'>"
                            f"<a href='https://company.service-now.com/sp'>"
                            f"https://company.service-now.com/sp</a></p>"
                            f"<img src='cid:image1'><br>"
                            f"<table><tr align='center'>"
                            f"<th><img src='cid:image2'></th>"
                            f"<th>{self.support_number}</th>"
    ...
    def send_manager_smtp(self):
        """Function to send the manager's email via SMTP"""
